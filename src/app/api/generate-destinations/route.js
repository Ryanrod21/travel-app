...
Do NOT include any explanation, markdown, or text outside this JSON. If you cannot produce valid JSON, respond with an empty array [].`,
  ...
  if (top10) {
    ...
    userMessage = `User is interested in traveling to ${prompt}. Don't give me more than 6. The user is currently located in ${location}. Include the best travel method and estimated travel time for each destination.`;
  }
