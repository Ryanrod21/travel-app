    ...
    <div className="pt-16 pb-26 min-h-screen bg-gradient-to-br from-blue-50 via-sky-50 to-indigo-50 text-gray-900">
      <section className="pt-24 pb-16 px-5">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-5xl md:text-7xl font-extrabold mb-8 bg-gradient-to-r from-blue-600 via-sky-500 to-indigo-600 bg-clip-text text-transparent">
            About Us
          </h1>

          <div className="bg-white p-8 md:p-12 max-w-3xl mx-auto rounded-xl shadow-lg space-y-6 text-gray-700 leading-relaxed text-lg md:text-xl text-left">
            <p>
